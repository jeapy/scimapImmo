...
/* nav.html.twig */
class __TwigTemplate_e8d94c30b16af8a8a837b5650510cb1db3407f7eb601b05bbd427de2ecec9cc1 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"dropdown-menu\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li><a href=\"{{path('projet')}}\">Souscription en ligne</a></li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li><a href=\"{{path('login')}}\">Compte client</a></li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"dropdown\">
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<ul class=\"dropdown-menu\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li><a href=\"{{path('blog')}}\">Nos Projets</a></li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t<li class=\"dropdown\">
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<li><a href=\"{{path('video')}}\">Video</a></li>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</ul>
\t\t\t\t\t\t\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t\t\t\t\t\t\t<li>
...
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t ", "nav.html.twig", "C:\\wamp\\www\\scimapimmo\\app\\views\\nav.html.twig");
    }
}
